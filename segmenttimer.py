...
Classes:
    SegmentTimer: Replicates an stopwatch and presents data as a table
...
class SegmentTimer():
    ...
    Methods:
        ref: Sets initial reference time
        lap: Adds segment to dictionary
        seg: Presents segment results
    """
